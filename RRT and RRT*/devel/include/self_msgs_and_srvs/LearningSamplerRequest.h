...
struct LearningSamplerRequest_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::self_msgs_and_srvs::input_point_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::self_msgs_and_srvs::input_point_<ContainerAllocator> >> _input_traj_type;
